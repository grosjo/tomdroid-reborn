...
public class TNextCloud
{
    ...
    void OauthSign(String u, String mode, ArrayList<String> params, String Secret) throws Exception
    {
        ...
        String signature = android.util.Base64.encodeToString(hmac,android.util.Base64.DEFAULT);
/*
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            signature = new String(java.util.Base64.getEncoder().encodeToString(hmac));
        }
        else
        {
            signature = android.util.Base64.encodeToString(hmac,android.util.Base64.DEFAULT);
        }
*/
    ...
    Boolean NCAuth()
    {
        ...
        try
        {
            String res = WebGet(TPrefs.getString(TPrefs.Key.SYNC_NC_URL) + "/api/1.0/", null);
