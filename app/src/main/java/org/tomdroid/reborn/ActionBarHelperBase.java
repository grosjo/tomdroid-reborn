...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    public void onPostCreate(Bundle savedInstanceState) {
        ...
        ActionBarSimpleMenu menu = new ActionBarSimpleMenu(mActivity);
    ...
    private void setupActionBar() {
        ...
        // Add Home button
        ActionBarSimpleMenu tempMenu = new ActionBarSimpleMenu(mActivity);
        ActionBarSimpleMenuItem homeItem = new ActionBarSimpleMenuItem(
