 ...
 * implementation.
 */
public class ActionBarSimpleMenu implements Menu {

    private Context mContext;
    private Resources mResources;

    private ArrayList<ActionBarSimpleMenuItem> mItems;

    public ActionBarSimpleMenu(Context context) {
        mContext = context;
        mResources = context.getResources();
        mItems = new ArrayList<ActionBarSimpleMenuItem>();
    }
    ...
    private MenuItem addInternal(int itemId, int order, CharSequence title) {
        final ActionBarSimpleMenuItem item = new ActionBarSimpleMenuItem(this, itemId, order, title);
    ...
    public int findItemIndex(int id) {
        ...
        for (int i = 0; i < size; i++) {
            ActionBarSimpleMenuItem item = mItems.get(i);
